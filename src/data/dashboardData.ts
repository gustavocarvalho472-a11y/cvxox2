...
const baseDataMap: Record<BusinessUnit, DashboardData> = {
  todos: {
    ...
    funnelStages: [
      { label: 'Leads PJ captados', value: 8400, delta: 12.5 },
      { label: 'Propostas enviadas', value: 3200, delta: 8.2, convRate: 38 },
      { label: 'Contratos ativos', value: 1840, delta: 5.4, convRate: 58 },
  ...
  seguros: {
    ...
    funnelStages: [
      { label: 'Leads PJ captados', value: 3100, delta: 10.2 },
      { label: 'Propostas enviadas', value: 1240, delta: 7.8, convRate: 40 },
      { label: 'Contratos ativos', value: 740, delta: 4.8, convRate: 60 },
  ...
  consorcios: {
    ...
    funnelStages: [
      { label: 'Leads PJ captados', value: 2200, delta: 8.4 },
      { label: 'Propostas enviadas', value: 820, delta: 6.1, convRate: 37 },
      { label: 'Contratos ativos', value: 460, delta: 4.2, convRate: 56 },
  ...
  cielo: {
    ...
    funnelStages: [
      { label: 'Leads PJ captados', value: 6400, delta: 14.8 },
      { label: 'Propostas enviadas', value: 2400, delta: 10.2, convRate: 38 },
      { label: 'Contratos ativos', value: 1380, delta: 7.1, convRate: 58 },
  ...
  outros: {
    ...
    funnelStages: [
      { label: 'Leads PJ captados', value: 820, delta: 5.2 },
      { label: 'Propostas enviadas', value: 310, delta: 3.8, convRate: 38 },
      { label: 'Contratos ativos', value: 180, delta: 2.8, convRate: 58 },
